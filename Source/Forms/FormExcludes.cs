    ...
    public partial class FormExcludes : Form
    {
        ...
        private void ResizeFilterListColumns()
        {
            if (listExcludes.Items.Count == 0)
            {
                ...
                listExcludes.Columns[4].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[5].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[6].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[7].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[8].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
            }
            else
            {
                listExcludes.Columns[0].AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent);
                listExcludes.Columns[1].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[2].AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent);
                listExcludes.Columns[3].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[4].AutoResize(ColumnHeaderAutoResizeStyle.HeaderSize);
                listExcludes.Columns[5].AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent);
                listExcludes.Columns[6].AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent);
                listExcludes.Columns[7].AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent);
                listExcludes.Columns[8].AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent);
            }
        }
